...
\renewcommand{\arraystretch}{2}
	...
	\large 3. & \large Jumer Wires(M-M) & \large 10 \\
...
\centering\begin{karnaugh-map}[2][2][1][$Y$][$X$]
    ...
    \implicant{2}{3}
\end{karnaugh-map}\\
\centering\large{\hspace{7mm}K-map}\vspace{2mm}\\
\raggedright\large{3.Connect inputs to arduino 2,3 digital pins and connect the output digital pin declared in the source code to one end of the resistor and connect the resistor's other end to the LED}\vspace{2mm}


\centering \href{https://github.com/BoleManideep/FWCmodule1/tree/main/Assignement1/codes}{"Souce Code Link"} \vspace{5mm}
